...
import { Category, Agent } from "@prisma/client";
...
export const AgentForm = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: initialData || {
      name: "New Agent",
      instructions: SEED_CHAT,
      seed: SEED_CHAT,
      src: "https://res.cloudinary.com/dfc0qtixt/image/upload/v1700171154/cygwvrtgceflme9ltqnt.jpg",  
      role: "agent",
    },
  });
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Write couple of examples of a human chatting with your AI Agent, write expected answers.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
